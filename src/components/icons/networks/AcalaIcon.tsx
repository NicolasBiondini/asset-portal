...
function AcalaIcon({ className }: { className: string }) {
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.008" stopColor="#645AFF"></stop>
          <stop offset="0.504" stopColor="#E40C5B"></stop>
          <stop offset="1" stopColor="#FF4C3B"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
